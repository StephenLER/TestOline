...
) ENGINE = InnoDB AUTO_INCREMENT = 1535 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `knowledge_frame`  (
  ...
  INDEX `chapter_parent_id`(`chapter_parent_id`) USING BTREE,
  INDEX `subject_id`(`subject_id`) USING BTREE,
  INDEX `is_knowledge`(`is_knowledge`) USING BTREE,
...
CREATE TABLE `question`  (
  ...
  INDEX `fk`(`knowledge_id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 7283 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 48384 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
